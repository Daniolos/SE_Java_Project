...
public class Artikel {
	...
	public boolean checkGewicht(String gewicht) {
		...
		try {
			if (((einheit.equals("g")) && (Float.parseFloat(gewicht) >= 1) && (Float.parseFloat(gewicht) <= 100000))
					|| ((einheit.equals("kg")) && (Float.parseFloat(gewicht) >= 0.1)
							&& (Float.parseFloat(gewicht) <= 100))
					|| ((einheit.equals("l")) && (Float.parseFloat(gewicht) >= 0.1)
							&& (Float.parseFloat(gewicht) <= 100))
					|| ((einheit.equals("ml")) && (Float.parseFloat(gewicht) >= 1)
	...
	public boolean checkPreis(String preis) {
		...
		try {
			if (!(0.01 <= Float.parseFloat(preis.replace(",", "."))
	...
	public boolean checkGrundpreis(String grundpreis) {
		...
		try {
			if (!(0.01 <= Float.parseFloat(grundpreis.replace(",", "."))
	...
	/**
	 * Konstruktor für Artikel. Übernimmt Strings aller Artikeleigenschaften (neun
	 * Strings) und weist sie einem Artikel zu.
	 * 
	 * @param name       Name des Artikels
	 ...
	 */
	public Artikel(String name, String ean, String kategorie, String einheit, String peinheit, String gewicht,
	 ...
	 * 
	 * @return Array, dass die Artikeleigenschaften in folgender Reihenfolge
	 *         enthält: 1. Name des Artikels 2. EAN/ PLU 3. Stückpreis 4. Anzahl
	 *         (Wie oft ist der Artikel im Lager?) 5. Grundpreis 6.
	 *         Grundpreiseinheit (€/kg, €/100g,...) 7. Gewicht 8. Einheit (kg, g, l,
	 *         ml, p) 9. Kategorie
	 */
	...
	/**
	 * Setter-Methode für die Grundpreiseinheit dieses Artikels. Überprüft vor der
	 * Zuweisung, ob die übergebene Grundpreiseinheit zulässig ist. Ist sie das
	 * nicht, wird diesem Artikel ein leerer String als Grundpreiseinheit
	 * zugewiesen, sonst der übergebene.
	 * 
	 * @param peinheit Grundpreiseinheit
	 */
	...
	/**
	 * Setter-Methode für den Namen dieses Artikels. Überprüft vor der Zuweisung, ob
	 * der übergebene Name zulässig ist. Ist er das nicht, wird diesem Artikel ein
	 * leerer String als Name zugewiesen, sonst der übergebene.
	 * 
	 * @param name Name
	 */
	...
	/**
	 * Setter-Methode für die EAN dieses Artikels. Überprüft vor der Zuweisung, ob
	 * die übergebene EAN zulässig ist. Ist sie das nicht, wird diesem Artikel ein
	 * leerer String als EAN zugewiesen, sonst die übergebene EAN.
	 * 
	 * @param ean EAN
	 */
	...
	/**
	 * Setter-Methode für das Gewicht dieses Artikels. Überprüft vor der Zuweisung,
	 * ob das übergebene Gewicht zulässig ist. Ist es das nicht, wird diesem Artikel
	 * ein leerer String als Gewicht zugewiesen, sonst das übergebene.
	 * 
	 * @param gewicht Gewicht
	 */
	...
	/**
	 * Setter-Methode für die im Lager vorhandene Anzahl dieses Artikels. Überprüft
	 * vor der Zuweisung, ob die übergebene Anzahl zulässig ist. Ist sie das nicht,
	 * wird diesem Artikel ein leerer String als "Anzahl" zugewiesen, sonst die
	 * übergebene.
	 * 
	...
	/**
	 * Setter-Methode für den Stückpreis dieses Artikels. Überprüft vor der
	 * Zuweisung, ob der übergebene Stückpreis zulässig ist. Ist er das nicht, wird
	 * diesem Artikel ein leerer String als Stückpreis zugewiesen, sonst der
	 * übergebene.
	 * 
	...
	/**
	 * Setter-Methode für den Grundpreis dieses Artikels. Überprüft vor der
	 * Zuweisung, ob der übergebene Grundpreis zulässig ist. Ist er das nicht, wird
	 * diesem Artikel ein leerer String als Grundpreis zugewiesen, sonst der
	 * übergebene.
	 * 
	 * @param grundpreis Grundpreis
	 */
	...
	/**
	 * Setter-Methode für die Mengeneinheit dieses Artikels. Überprüft vor der
	 * Zuweisung, ob die übergebene Mengeneinheit zulässig ist. Ist sie das nicht,
	 * wird diesem Artikel ein leerer String als Mengeneinheit zugewiesen, sonst die
	 * übergebene.
	 * 
	...
	/**
	 * Weist diesem Artikel seine in der XML-Datei gespeicherte Grundpreiseinheit
	 * zu.
	 */
	...
	/**
	 * Weist diesem Artikel seine in der XML-Datei gespeicherte Anzahl (Wie oft ist
	 * er im Lager vorhanden?) zu.
	 */
