...
public class GUIEinkauf extends JFrame
	...
	private JTable einkaufsListe;
		...
		String[] columnNames = {"Artikelname", "EAN", "Preis", "St√ºckzahl"};
			
		Object[][] dataBestand = {												// Datens√§tze m√ºssen sp√§ter noch aus txt oder √§hnlichen dateien geholt werden
		...
		this.getContentPane().add(einkaufsListeLabel);											// Einkaufsliste zur graphischen Oberfl‰che hinzuf¸gen
		...
		this.getContentPane().add(bestandsListeLabel);											// Bestandsliste zur graphischen Oberfl‰che hinzuf¸gen
