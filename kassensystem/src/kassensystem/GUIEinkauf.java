...
public class GUIEinkauf extends JFrame
	...
	private JTable einkaufsListe;
		...
		this.getContentPane().add(einkaufsListeLabel);											// Einkaufsliste zur graphischen Oberfl夨e hinzuf??
		...
		this.getContentPane().add(bestandsListeLabel);											// Bestandsliste zur graphischen Oberfl夨e hinzuf??
